...
<nav class="navbar navbar-expand-md navbar-dark bg-dark text-white"
    ...
    <div
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-link"><a class="nav-link" href="${pageContext.request.contextPath}/logout">로그아웃</a></li>
                <li class="nav-link active"><a id="test" class="nav-link" href="${pageContext.request.contextPath}/mypageHome?idx=${loginUser.idx}">마이페이지</a>
            </c:if>
        </ul>
    </div>
</nav>
