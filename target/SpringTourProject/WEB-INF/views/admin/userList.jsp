            ...
            <div class="col-sm-12 text-center">
                ...
                <table class="table table-striped m-12" id="bbs">
                    ...
                    <c:if test="${userList ne null and not empty userList}">
                        <c:forEach var="user" items="${userList}">
                            <tr class="record">
                                ...
                                <td><c:if test="${user.stat==0 }">
                                    인증필요
                                </c:if> <c:if test="${user.stat==1 }">
                                    활동회원
                                ...
                                <td><a href="/admin/userDelete?idx=${user.idx}">회원탈퇴</a></td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="text-align: center">${pageNavi}</td>
...
<!-- 수정 form시작-------------------- -->
<form name="frm2" method="GET"></form>
<!-- ------------------------------------- -->
