    ...
    <div
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <c:if test="${loginUser ne null}">
                ...
                <li class="nav-link active"><a class="nav-link" href="${pageContext.request.contextPath}/logout.do">로그아웃</a></li>
   			 <li class="nav-link active"><a class="nav-link" href="${pageContext.request.contextPath}/mypageHome.do">마이페이지</a>
            </c:if>
        </ul>
    </div>
</nav>
