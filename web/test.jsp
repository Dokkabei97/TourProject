...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark" id="font1">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#myLoginModal" data-toggle="modal">포인트샵</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/logout.do">명예의 전당</a>
            </li>
        </ul>
    </div>
</nav>
